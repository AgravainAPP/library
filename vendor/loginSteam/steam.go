...
import (
	...
	"api-leagueoflegends/Domain/steamUser"
)
...
func (id OpenId) ValidateAndGetUser(apiKey string) (*steamuser.PlayerSummaries, error) {
	steamId, err := id.ValidateAndGetId()
	if err != nil {
		return nil, err
	}
	return steamuser.GetPlayerSummaries(steamId, apiKey)
}
